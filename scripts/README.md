...
- Boxplots and Hypothesis Testing: Run *2_hyptest_&_boxplots.R* to generate statistical analyses and boxplots
- Glycosylation Proportions Visualization: Run *3_sector_diagrams.R* to create pie charts
